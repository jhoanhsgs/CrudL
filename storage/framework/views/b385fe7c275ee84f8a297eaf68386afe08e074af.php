...
<div class="wrapper">
    ...
    <!-- Sidebar -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('usuarios.index')): ?>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo e(url('/admin/usuarios')); ?>" class="nav-link">
              ...
              <li class="nav-item menu">
                <a href="<?php echo e(url('/admin/tienda')); ?>" class="nav-link active">
          ...
          <li class="nav-item menu">
            <a href="<?php echo e(url('/admin/mi_unidad')); ?>" class="nav-link active">
              <i class="nav-icon fas"><i class="bi bi-folder-plus"></i></i>
              <p>
                Mi unidad
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/admin/almacen')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo e(URL('/admin/proveedores')); ?>" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item menu">
            <a href="<?php echo e(url('/admin/cuentas')); ?>" class="nav-link active">
              <i class="nav-icon fas"><i class="bi bi-folder-plus"></i></i>
              <p>
                Cuentas
        ...
        <?php if(auth()->guard()->guest()): ?>
                        ...
                        <?php else: ?>
                        <li class="nav-item" >
                            <a class="nav-link" href="<?php echo e(route('logout')); ?>" style="background-color: #d82912"
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022-2024 <a href="<?php echo e(URL('/')); ?>">Evoluciontv.live</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<?php /**PATH C:\xampp\htdocs\crudlaravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>