            ...
            <div class="card-body" style="display: block;">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo e(url('admin/almacen')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="P-<?php echo e($resultado); ?>" name="codigo" hidden>
                                                <input type="text" class="form-control" value="P-<?php echo e($resultado); ?>" name="" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo e(Auth::user()->email); ?>" name="user" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                            ...
                            <hr>
                            <div class="form-group">
                                <a href="<?php echo e(route('almacen.index')); ?>" class="btn btn-secondary">Cancelar</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crudlaravel\resources\views/admin/almacen/create.blade.php ENDPATH**/ ?>