    ...
    <div class="row mb-2">
        <div class="col-sm-8">
            <h1 class="m-0">Listado de compras
                <a href="{{ url('admin/create/compra') }}" class="btn btn-primary" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-target="#modal_producto{{ $compra->id }}">
                                                {{ $compra->producto->nombre }}
                                            </button>

                                            <!-- Modal vizualizar datos del producto -->
                                            <div class="modal fade" id="modal_producto{{ $compra->id }}" >
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ $compra->producto->nombre }}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">Descripción del producto</label>
                                                                            <input type="text" value="{{ $compra->producto->descripcion}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ $compra->producto->categoria->nombre}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <img src="{{asset('storage/productos/'.$compra->producto->imagen)}}" width="100%" alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" data-toggle="modal"
                                                        data-target="#modal-proveedor{{ $compra->id}}">
                                                        {{ $compra->proveedor->nombre}}
                                                </button>

                                                <!-- modal para visualizar datos de los proveedor -->
                                                <div class="modal fade" id="modal-proveedor{{ $compra->id}}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ $compra->proveedor->nombre}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">Celular del proveedor</label>
                                                                            <a href="https://wa.me/57{{ $compra->proveedor->celular}}" target="_blank" class="btn btn-success">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ $compra->proveedor->telefonoe}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">Empresa</label>
                                                                            <input type="text" value="{{ $compra->proveedor->empresa}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ $compra->proveedor->email}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">Dirección</label>
                                                                            <input type="text" value="{{ $compra->proveedor->direccion}}" class="form-control" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <td>
                                            <center>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="{{route('compras.show',$compra->id)}}" type="button" class="btn btn-info"><i class="bi bi-eye"></i></a>
                                                    <a href="{{route('compras.edit',$compra->id)}}" type="button" class="btn btn-success"><i class="bi bi-pencil"></i></a>
                                                  </div>
                                            </center>
                                        </td>
                                    </tr>
